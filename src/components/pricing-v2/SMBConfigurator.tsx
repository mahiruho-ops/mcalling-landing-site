...
export function SMBConfigurator() {
  return (
    <Suspense fallback={<SMBConfiguratorFallback />}>
      <SMBConfiguratorContent />
    </Suspense>
  );
}
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            <div className="h-[520px] rounded-2xl border border-border/60 bg-muted/20 animate-pulse" />
            <div className="h-[320px] rounded-2xl border border-border/60 bg-muted/20 animate-pulse" />
          </div>
        </div>
      </div>
    </section>
...
function SMBConfiguratorContent() {
