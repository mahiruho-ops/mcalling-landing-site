  ...
  smb: {
    ...
    result: {
      ...
      setupUsageCreditFootnote:
        "This one-time credit is separate from prepaid minute packages. Final terms are confirmed in your order.",
      ...
      rechargePackagesTitle: "Prepaid minutes packages",
      rechargePackagesIntro:
        "Recharge with any package below. Minutes are consumed at your plan rate for connected talk time.",
      rechargePackagesMinutesColumn: "Minutes",
      rechargePackagesValidityColumn: "Validity",
      rechargePackagesRateLine: "Your {tier} plan rate: ₹{rate}/min (ex-GST). GST @ 18% is additional on recharge.",
      ...
      summaryPlanRateLine: "Prepaid recharges billed at ₹{rate}/min (ex-GST) on the {tier} plan",
      summaryDurationLine: "Average connected call duration (your input): {duration}",
      summaryConcurrencyLine: "Concurrent capacity: {paths} path(s){inferred}",
      summaryUseCasesLine: "Use cases selected: {count}",
      summaryUsageCreditLine:
        "One-time usage credit from setup: {minutes} min at ₹{rate}/min (ex-GST){validity}",
      summaryComplexityLine: "Workflow complexity: {complexity}",
      summaryIntegrationLine: "Custom integration likely: {answer}",
      summaryIntegrationUnlikely: "Unlikely from selections",
