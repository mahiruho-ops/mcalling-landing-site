export const scheduleDemoContent = {
  ...
  whatToExpect: {
    ...
    items: [
      ...
      "Explanation of inbound and outbound calling flows",
      "How managed setup and onboarding works",
      "Pricing walkthrough based on your expected volumes",
      "Q&A with our product team"
    ],
    keyMessage: "This is a consultation, not a sales pitch."
  },
  whoIsThisFor: {
    ...
    goodFit: {
      ...
      items: [
        "An SMB or growing business",
        "Handling sales, support, reminders, or follow-up calls",
        "Spending time or money on manual calling",
        "Looking for predictable calling costs",
        "Interested in automation without AI complexity"
      ]
    },
    notRequired: {
      title: "Not Required",
